...
class Dirty implements HashMap<String, Object> {
  ...
  @override
  Iterable<MapEntry<String, Object>> get entries => null;

  @override
  Map<K2, V2> map<K2, V2>(MapEntry<K2, V2> Function(String key, Object value) f) {
    // TODO: implement map
  }
  ...
  @override
  Object update(String key, Object Function(Object value) update, {Object Function() ifAbsent}) {
